		...
		<div class="row">
			<div class="col-md-12"><br><br>
					...
					<div class="col-md-6">
						<div class="input-group">
							<div class="form-group">
							    <select class="form-control" disabled="" id="exampleFormControlSelect1" style="border:none; background-color: transparent;" >
							      <option selected>Branch </option>
							    </select>
							  </div>
							<div class="form-group">
							    <select class="form-control" id="exampleFormControlSelect1" style="border-top:none;border-right:none;border-left:none;border-color:black;">
				...
				<div class="row">
					<table >
						<tr>
							<td><label>ACCOUNTABLE STAFF:</label></td>
							<td><input type="" name="" style="border-top:none;border-right:none;border-left:none;border-color:black;"size="35"></td>
						</tr>
						<tr>
							<td><center><label>DEPARTMENT : </label></center></td>
							<td><input type="text" name="" style="border-top:none;border-right:none;border-left:none;border-color:black;"size="35"></td>
						</tr>
					</table>
				</div>
				<div class="row">
					<div class="col-md-12">
						<table class="responsive">
							<tr>
								<td colspan="4">TEAM DETAILS</td>
								
							</tr>
							<tr>
								<td><label>NAME : </label></td>
								<td>&nbsp;<input type="text"size="30" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black; ">&nbsp;&nbsp;&nbsp;</td>
								<td>&nbsp;<input type="text"size="30" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black; ">&nbsp;&nbsp;&nbsp;</td>
								<td>&nbsp;<input type="text"size="30" name="" class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black;">&nbsp;&nbsp;&nbsp;</td>
							</tr>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<tr>
									<td width="265"><center>BRANCH</center></td>
									<td width="440"><center>PURPOSE</center></td>
									<td width="20" colspan="2"><center>PERIOD</center></td>
									<td width="75"><center>NO. OF DAYS</center></td>
								</tr>
								<tr>
									<td><select class="form-control" id="exampleFormControlSelect1" style="border-top:none;border-right:none;border-left:none;border:none;color:black;" size="">
							      <option selected>Choose Branch here...</option>
							      <option>Gaisano Capital Bacayan</option>
							      <option>Gaisano Capital Basak</option>
							      <option>Gaisano Capital Balasan</option>
							      ...
							      <option>Gaisano Capital Mintal</option>
							      <option>Gaisano Capital OPM</option>
							      <option>Gaisano Capital Ormoc</option>
							      <option>Gaisano Capital Ormoc Savers</option>
							      <option>Gaisano Capital Ormoc Central</option>
							      <option>Gaisano Capital OTON</option>
							      <option>Gaisano Capital Ozamis</option>
							      ...
							      <option>Gaisano Capital Tacloban Main</option>
									...
									<td rowspan="2"><textarea class="form-control" name="purpose" rows="2" cols="27"></textarea></td>
									<td><center>Start</center></td>
									<td><input type="date" name=""class="col-11" id="pick_date"onchange="cal()" style="border-top:none;border-right:none;border-left:none;  "></td>
									<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;  "readonly=""></td>
								</tr>
								<tr>
									<td><input type="text" name=""class="col-11" style="border-top:none;border-right:none;border-left:none;  "></td>
									
									<td><center>End</center></td>
									<td><input type="date" name="" class="col-11" id="drop_date"onchange="cal()" style="border-top:none;border-right:none;border-left:none;"></td>
									<td><center><input type="text" name="" id="numdays2"class="col-12" style="border-top:none;border-right:none;border-left:none;  " readonly="" placeholder="Day/s"></center></td>
								</tr>
							</table>
							</div>
						</div><br>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<tr>
									<td width="80"><center># OF EMP</center></td>
									<td width="250"><center>FROM - TO</center></td>
									<td width="500"><center>PARTICULARS</center></td>
									<td width="20"><center>AMOUNT</center></td>
								</tr>
								<tr>
									<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;  "></td>
									<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;  "></td>
									<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;  "></td>
									<td><input type="number" name="" class="sum col-12" onchange="add()" style="border-top:none;border-right:none;border-left:none;text-align: right;"></td>
								</tr>
								...
								<tr>
									...
									<td><input type="number" readonly name="" id="total" class="sumss" onchange="addss()" style="border-top:none;border-right:none;border-left:none;text-align: center;"></td>
								</tr>
								</table><br>
									...
									<div class="col-md-12">
										<table border="1">
											...
											<tr>
												...
												<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;  "onkeyup="calc()"></td>
												<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;  "onkeyup="calc()"></td>
												<td colspan="2"><center><input type="number" name="" style="border-top:none;border-right:none;border-left:none;text-align: right;" class="sums col-12" onchange="adds()" onkeyup="calc()"></center></td>
											</tr>
											<tr>
												<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;  "onkeyup="calc()"></td>
												<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;  "onkeyup="calc()"></td>
											...
											<tr>
												...
												<td  style="float: right; border:none;" ><label>SUB-TOTAL-------------</label></td>
												<td colspan="2"><center><input type="number" name="" class="sumss col-12" readonly onchange="addss()" id="totals" style="border-top:none;border-right:none;border-left:none;text-align: right;"></center></td>
											</tr>
											<tr>
								...
								<div class="row">
									<div class="col-md-12">
										<table>
											...
											<tr>
												<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black;" size="25"></td>
												<td width="60px"></td>
												<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black;"></td>
												<td width="60px"></td>
												<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black;"></td>
												<td width="60px"></td>
												<td><input type="text" name=""class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black;"></td>
											...
											<tr>
												<td colspan="6"></td>
												<td style="float: right;" class="noprint"><button class="btn btn-outline-primary" id="justprint" onclick="window.print();return false;">Print</button></td>
											</tr>
										</table>
									</div>
								</div>
...
<script type="text/javascript">
    ...
    function cal(){
     ...
     <!--  <script>
        setTimeout(responsiveVoice.speak("Welcome to Travel Form"),15000);
      </script> -->
