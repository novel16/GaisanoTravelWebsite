...
<canvas id=c></canvas>
 ...
 <div class="container-fluid"><br><br>
  <div class="row">
    ...
    <div class="col-md-12 mt-5"><h1><center>
    ...
    <div class = "bg-light border shadow  w-25 mt-5 p-5  m-auto rounded-3">
        <div class = "">
        <strong><b><h1 class = "text-center mb-3 text-info" >ADMINISTRATOR</h1></b></strong>
        </div>
      ...
      <?php } ?>
        ...
        <div class = "">
            <form action="../administrator/login.php" method ="POST">
                ...
                <div class="mb-3">
                <strong><label for="username" class="mb-2">Username</label></strong>
                    <input type="text" class="form-control" name ="username" id="username" placeholder="Enter username" >
                </div>
                <div class="mb-3">
                <strong><label for="password" class ="mb-2">Password</label></strong>
                    <input type="password" class="form-control" name ="password" id="password" placeholder="Enter password">
                </div>
                <button type = "submit" name ="save" class = "btn btn-primary my-4 w-100">Login</button>
