				...
				<div class="row">
					<table >
						<tr>
                            ...
                            <td style ="float:right;" class="ml-5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $status ?></td>
					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								...
								$query = "SELECT * FROM `travel_info` WHERE `branch1`='$branch1' AND `account_staff`='$account_staff' AND `start_date`='$start_date' AND`end_date`='$end_date' AND status ='Rejected'";
								...
								<div class="row">
									...
									<div class="col-md-12">
										...
										$query1 = "SELECT * FROM `travel_info` WHERE `branch1`='$branch1' AND `account_staff`='$account_staff' AND `start_date`='$start_date' AND `end_date`='$end_date' AND status ='Rejected'";
