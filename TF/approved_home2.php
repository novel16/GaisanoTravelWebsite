					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<tr>
									<td><input type ="text" class="form-control" name ="branch2"  id="branch2" value = "<?php echo $row['branch2'] ?>" style="border-top:none;border-right:none;border-left:none;border:none;color:black;" size="">
							      <!-- <option selected>Choose Branch here...</option>
							      <option>Gaisano Capital Bacayan</option>
							      <option>Gaisano Capital Basak</option>
							      <option>Gaisano Capital Balasan</option>
							      ...
							      <option>Gaisano Capital Tacloban Main</option>
									...
									<td rowspan="2"><textarea value=""  placeholder="" class="form-control text-center" name="purpose" id="purpose"  rows="4" cols="27" style="font-size: 18px; border:none;"><?php echo $row['purpose'] ?></textarea></td>
									<td><center>Start</center></td>
									<td><input type="date" name="start_date"   class="col-11" id="pick_date"onchange="cal()" value ="<?php echo $row['start_date'] ?>" style="border-top:none;border-right:none;border-left:none;  "></td>
						...
						<div class="row">
							<div class="col-md-12">
								...
								$query = "SELECT * FROM `travel_info` WHERE `branch1`='$branch1' AND `account_staff`='$account_staff' AND `start_date`='$start_date' AND `end_date`='$end_date'";
								...
								<tr border = "1">
									...
									<td><input type="text" value="<?php echo $row1['emp_no'] ?>" name="emp_no[]" class="col-12  form-control" style="border-top:none;border-right:none;border-left:none; border-bottom:none;"></td>
									<td><input type="text" value="<?php echo $row1['from_to'] ?>"  name="from_to[]" class="col-12  form-control" style="border-top:none;border-right:none;border-left:none; border-bottom:none;"></td>
									<td><input type="text" value="<?php echo $row1['particular'] ?>" name="particular[]" class="col-12  form-control" style="border-top:none;border-right:none;border-left:none;border-bottom:none;"></td>
									<td><input type="number" value="<?php echo $row1['amount_liquidate'] ?>" name="amount_liquidate[]" class="sum col-12 form-control" onchange="add()" style=" border-top:none;border-right:none;border-left:none;text-align: center; border-bottom:none;"></td>	
								</tr>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<table border="1">
											...
											<tr>
												<td><input type="number"  name="bracket[]" id="bracket"   class=" col-12 total_bracket text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; "  ></td>
												<td><input type="text"  name="employee_no[]" id="no_emp" class=" col-12 total_bracket text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none;border-bottom:none;  " ></td>
												<td><input type="number"  name="no_of_days[]" id="num_days"  class=" col-12 total_bracket text-center"  style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; " ></td>
												<td colspan="2"><center><input type="number" id="total_bracket" readonly name="amount[]" style="font-size: 18px; border-top:none;border-right:none;border-left:none;text-align: right; border-bottom:none;" class="sums col-12 btn_bracket text-center"  ></center></td>
											</tr>
											<tr>
												<td><input type="number"  name="bracket[]" id="bracket2"   class="col-12 total_bracket2 text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; " onkeyup="calc()" ></td>
												<td><input type="text"  name="employee_no[]" id="no_emp2" class="col-12 total_bracket2 text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none;border-bottom:none;  "onkeyup="calc()" ></td>
												<td><input type="number"  name="no_of_days[]" id="num_days2" class="col-12 total_bracket2 text-center"  style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; " onkeyup="calc()"></td>
												<td colspan="2"><center><input type="number" id="total_bracket2" readonly name="amount[]" style="font-size: 18px; border-top:none;border-right:none;border-left:none;text-align: right; border-bottom:none;" class="sums col-12 btn_bracket text-center" onchange="adds()" onkeyup="calc()" ></center></td>
											</tr>
											<tr>
												<td><input type="number"  name="bracket[]" id="bracket3"   class="col-12 total_bracket3 text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; " onkeyup="calc()" ></td>
												<td><input type="text"  name="employee_no[]" id="no_emp3" class="col-12 total_bracket3 text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none;border-bottom:none;  "onkeyup="calc()" ></td>
												<td><input type="number"  name="no_of_days[]" id="num_days3" class="col-12 total_bracket3 text-center"  style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; " onkeyup="calc()"></td>
												<td colspan="2"><center><input type="number" id="total_bracket3" readonly name="amount[]" style="font-size: 18px; border-top:none;border-right:none;border-left:none;text-align: right; border-bottom:none;" class="sums col-12 btn_bracket text-center" onchange="adds()" onkeyup="calc()" ></center></td>
											</tr>
											<tr>
												<td><input type="number"  name="bracket[]" id="bracket4"   class="col-12 total_bracket4 text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; " onkeyup="calc()" ></td>
												<td><input type="text"  name="employee_no[]" id="no_emp4" class="col-12 total_bracket4 text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none;border-bottom:none;  "onkeyup="calc()" ></td>
												<td><input type="number"  name="no_of_days[]" id="num_days4" class="col-12 total_bracket4 text-center"  style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; " onkeyup="calc()"></td>
												<td colspan="2"><center><input type="number" id="total_bracket4" readonly name="amount[]" style="font-size: 18px; border-top:none;border-right:none;border-left:none;text-align: right; border-bottom:none;" class="sums col-12 btn_bracket text-center" onchange="adds()" onkeyup="calc()" ></center></td>
											</tr>
											...
											<tr>
												<td colspan="2" style="border: none;"></td>
												<td  style="float: right; border:none;" ><label>SUB-TOTAL</label></td>
												<td colspan="2"><center><input type="number" name="total" value = "" class="sumss col-12 text-center " readonly onchange="addss()" id="totals" style="border-top:none;border-right:none;border-left:none;text-align: right;border-bottom:none;"></center></td>
											</tr>
											<tr>
												<td style="border: none;"></td>
												<td colspan="2" style="border:none; text-align: right" >GRAND TOTAL FOR CASH ADVANCE--------------------------------------</td>
												<td style="border-right:none;"><center>
													<input type="number" id="display" name="overall_total" class="form-control" value = "" style="border:none; text-align:center;"  readonly></center></td>
												<td style="border: none;"></td>
											</tr>
										</table>
										...
										<div class="row">
											<div class="col-md-11 mt-2">
												<button onclick="adds()" style="float:right;" class="btn btn-outline-danger btn_compute" id="noprint">Compute</button>
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<table>
											...
											<tr>
												<td colspan="6"></td>
												<td style="float: right;" ><button type ="submit"  class="btn btn-success mt-3  btn-sm " style="font-size:16px;" name ="save" id= "noprint" >Save</button></td>
												<td colspan="6"></td>
												...
												<td colspan="6"></td>
												<td style="float: right;"><a href="../TF/details.php" class = "link-danger btn btn-danger btn-sm" style="font-size:16px;" id = "noprint">Back</a></td>
												<!-- <td colspan="6"></td> -->
