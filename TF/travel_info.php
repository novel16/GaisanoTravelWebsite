...
<nav class = "p-4 bg-dark">
    <div class="nav-content ">
      <div class="logo">
        ...
        <b><h2 class = "text-info">AUDIT TRAVEL SYSTEM - APPROVED</h2></b>
      </div>
      ...
      <li><a href="../TF/dashboard.php" class = "link-dark text-light ">HOME</a></li>
        ...
        <li><a href="../TF/travel_info.php" class = "link-success text-success">APPROVED <b class="text-success">[<?php echo $row['total_approve'] ?>]</b></a></li>
