...
<body>
<nav class = "p-1 bg-dark fixed shadow">
    <div class="nav-content ">
      <div class="logo">
       
        <b><h2 class = "text-info">AUDIT TRAVEL SYSTEM - TRAVEL INFO</h2></b>
      </div>
      <ul class="nav-links mt-2 ">
      <li><a href="../TF/dashboard.php" class = "link-info text-light ">HOME</a></li>
        <li><a href="../TF/admin.php" class = "link-primary text-primary">TRAVEL INFORMATION </a></li> 
...
<div class = "p-5 mt-5" id="admin_load">
  ...
  <tr>
    <th><small>Emp_Name</th>
    <th><small>Department</th>
    <th><small>Branch</th>
    <th><small>Destination</th>
    <!-- <th><small>Purpose</th> -->
    <th><small>Date From</th>
    <th><small>Date To</th>
    <!-- <th >Status</th> -->
    <th><small>Tools</th>
  </tr>
...
$sql = "select t.id,t.emp_no, u.firstname, u.lastname, t.branch1, t.branch2, t.purpose, t.from_to, t.department, t.start_date, t.end_date, t.days_no, t.status from travel_info as t INNER JOIN users as u ON t.user = u.user_name WHERE status = 'Pending' and num_row = '1' ORDER BY id DESC";
$result = mysqli_query($con, $sql);
...
<tr class = "text-center">
          ...
          <td><small><?php echo $row['firstname'] ?> <?php echo $row['lastname'] ?></td>
          <td><small><?php echo $row['department'] ?></td>
          <td><small><?php echo $row['branch1'] ?></td>
          <td><small><?php echo $row['branch2'] ?></td>
          <!-- <td><small><?php echo $row['purpose'] ?></td> -->
          <td><small><?php echo $row['start_date']?></td>
           <td><small><?php echo $row['end_date']?></td>
          ...
          <a href="../TF/audit_home2.php?id=<?php echo $row['id'] ?>" class = "btn btn-success btn-sm" >Details</a>
