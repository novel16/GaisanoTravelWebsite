...
<div class="container" >
		...
		<div class="row">
			<div class="col-md-12"><br>
				...
				<p name = "branch1"><center><?php echo $branch ?></center></p>
					...
					<div class="col-md-6">
						...
						<div class="input-group text-center">
							<div class="form-group">
							    <!-- <select class="" disabled="" name="branch1" id="exampleFormControlSelect1" style="border:none; background-color: transparent;" > -->
							      <!-- <option selected>Branch:</option> -->
								  
							    </select>
							  </div>
							<div class="form-group">
							    <!-- <center><input type = "text" class="" id="branch1" name = "branch1" value = "<?php echo $branch ?>" readonly style="border-top:none;border-right:none;border-left:none;border-color:black;"></center> -->
					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<tr>
									<td><select class="form-control" placeholder = "Choose Branch here..." name ="branch2" id="branch2" style="border-top:none;border-right:none;border-left:none;border:none;color:black;" size="" required = "required">
							      <option selected>Choose Branch here...</option>
							      <option>Gaisano Capital Bacayan</option>
							      <option>Gaisano Capital Basak</option>
							      <option>Gaisano Capital Balasan</option>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<tr colspan="2">
									...
									<td><b><input type="text"  name="from_to[]" class="col-12 form-control" style=" border-top:none;border-right:none;border-left:none; border-bottom:none;"></b></td>
									<td><b><input type="text"  name="particular[]" class="col-12 form-control" style="border-top:none;border-right:none;border-left:none;border-bottom:none;"></b></td>
									<td><b><input type="number"  name="amount_liquidate[]" class="sum col-12  text-center" onchange="add()" style="border-top:none;border-right:none;border-left:none;text-align: right; border-bottom:none;"></b></td>	
								</tr>
								<tr colspan="2">
									<td><b><input type="text"  name="emp_no[]" class="col-12 form-control text-center" style=" border-top:none;border-right:none;border-left:none; border-bottom:none;"></b></td>
									<td><b><input type="text"  name="from_to[]" class="col-12 form-control" style=" border-top:none;border-right:none;border-left:none; border-bottom:none;"></b></td>
								...
								<tr>
									...
									<td align ="right" style=" border:none;" ><label>SUB-TOTAL</label></td>
									<td colspan="2"><center><input type="number" name="total_liquidate" class="sumss col-12 " readonly onchange="addss()" id="total" style="border-top:none;border-right:none;border-left:none;text-align: right;border-bottom:none"></center></td>
								</tr>
								</table>
								<!-- dup -->
									...
									<div class="col-md-12">
										<table border="1" id="table">
											...
											<tr>
												...
												<td align = "right" style="float: right; border:none; border-top: none;" ><label>SUB-TOTAL</label></td>
												<td  colspan="2"><center><input type="number" name="total" class="form-control sumss col-12 text-center" required onchange="myFun()" id="totals" onkeyup="calc()" style="border-top:none;border-right:none;border-left:none;text-align: right; border-bottom:none; border-top:none;"></center></td>
											</tr>
											
											<tr>
												<td style="border: none;"></td>
												<td colspan="2" style="border:none;" align ="right" >GRAND TOTAL FOR CASH ADVANCE----------------------------------------</td>
												<td style="border-right:none;"><input type ="number"  id ="display" name = "overall_total" class="total form-control text-center" style="border:none; text-align:center;" onchange ="myFun()" required = "required"></td>
												<td style="border: none;"></td>
											</tr>
										</table>
										...
										<!-- <div class="row mt-3">
											<div class="col-md-11" id ="noprint">
												<button style="float:right;" class="btn btn-success ml-2 add_row" >Add Row</button>
												<button style="float:right;" id="remove" class="btn btn-danger remove_btn" >Remove</button>
											</div>
										</div>
										 -->
									...
									<div class="col-md-12">
										<table>
											...
											<tr>
												...
												<td width="10px"></td>
												<td><input type="text" name="review_by"class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black;" required = "required"></td>
												<td width="10px"></td>
												<td><input type="text" name="approve_by"class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black;" required = "required"></td>
												<td width="10px"></td>
												<td><input type="text" name="receive_by"class="col-12" style="border-top:none;border-right:none;border-left:none;border-color:black;" required = "required"></td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="6"></td>
												<td style = "float: right; " ><button type ="submit" style="" class="btn btn-success mt-3  btn-sm" name ="save" id= "noprint" >Save</button></td>
												<td colspan="6"></td>
												<td style="float: right;" class="noprint"><button class="btn btn-primary btn-sm" style="" id="justprint" onclick="window.print();return false;">Print</button></td>
												
												<td colspan="6"></td>
												<td style="float: right;" style="margin-right: 20px;" ><a href="../user_dash.php" style="" class=" btn btn-danger  btn-sm" id="noprint">Back</a></td>
											</tr>
