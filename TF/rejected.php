...
<nav class = "p-4 bg-dark">
    <div class="nav-content ">
      <div class="logo">
        ...
        <b><h2 class = "text-info">AUDIT TRAVEL SYSTEM - REJECTED</h2></b>
      </div>
      <ul class="nav-links mt-2 ">
      <li><a href="../TF/dashboard.php" class = "link-dark text-light ">HOME</a></li>
        <li><a href="../TF/admin.php" class = "link-primary text-light">PENDING <b class="text-primary">[<?php echo $row1['total_pending'] ?>]</b></a></li> 
        ...
        <li><a href="../TF/rejected.php" class = "link-danger text-danger">REJECTED <b class="text-danger">[<?php echo $row2['total_rejected'] ?>]</b></a></li>
...
$sql = "select t.id,t.emp_no, u.firstname, u.lastname, t.branch1, t.branch2, t.purpose, t.from_to, t.department, t.start_date, t.end_date, t.days_no, t.status from travel_info as t INNER JOIN users as u ON t.user = u.user_name WHERE status = 'Rejected' and num_row='1'";
$result = mysqli_query($con, $sql);
...
<tr class = "text-center">
          ...
          <td class="text-danger" style = "text-transform:uppercase;"><b><?php echo $row['status'] ?></b></td>
          <!-- <td>
          <a href="../TF/admin_home2.php?id=<?php echo $row['id'] ?>" class = "link-success btn btn-success text-light">Approve</a> -->
          <!-- <a href="#" class = "link-success btn btn-primary text-light">Details</a> -->
            <!-- <a href="../functions/reject_and_approve.php?id=<?php echo $row['id'] ?>" class = "link-danger btn btn-danger text-light">Reject</a>  -->
          <!-- </td> -->
        </tr>
<?php
}
