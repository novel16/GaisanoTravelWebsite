									...
									for($i = 1; $i<=$rowcount; $i++){
										...
										?>
											...
											<tr>
												...
												<td hidden><input type="text" value="<?php echo $row1['id'] ?>" name="id[]"  class="col-12 " style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; " ></td>
												<td><input type="text" value="<?php echo $row1['bracket'] ?>"  name="bracket[]"  class="col-12 " style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none; " ></td>
												<td><input type="text" value="<?php echo $row1['employee_no'] ?>" name="employee_no[]"  class="col-12 text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none;"></td>
												<td><input type="text" value="<?php echo $row1['no_of_days'] ?>" name="no_of_days[]"  class="col-12 text-center" style="font-size: 18px; border-top:none;border-right:none;border-left:none; border-bottom:none;  "></td>
												<td colspan="2"><center><input type="number"  value="<?php echo $row1['amount']?>" name="amount[]" style="font-size: 18px; border-top:none;border-right:none;border-left:none;text-align: right; border-bottom:none;" class="sums col-12 text-center" onchange="adds()"></center></td>
											</tr>
									...
									<div class="col-md-12">
										<table>
											...
											<tr>
												...
												<td style="float: right;"><button class ="btn btn-primary" name = "update">UPDATE</button></td> 
												<!-- <td style = "float:right"><button class ="btn btn-primary btn_update" value = "<?php echo $row1['id'] ?>" name = "update">UPDATE</button></td> -->
												<td colspan="6"></td>
												<td><a href="../TF/details.php" class = "link-danger btn btn-danger" id = "noprint">BACK</a></td>
